...
const STARTUPS = [
  ...
  },
  {
    ...
    stageClass: "sp-angel",
    name: "SkillVillage",
    cat: "EdTech · Vocational Training",
      ...
      <div className="container">
        ...
        <div className="st-grid">
          {STARTUPS.map((s, i) => (
            <div
              key={s.name}
              className={`st-card reveal ${i % 3 !== 0 ? `delay-${i % 3}` : ""}`}
            >
              <div className="st-card-top">
                <div className="st-icon" style={{ background: s.bg }}>
                  {s.icon}
                </div>
              ...
              <div className="st-footer">
                ...
                <button className="st-link" onClick={() => {}}>
                  View Pitch →
                </button>
              </div>
            </div>
